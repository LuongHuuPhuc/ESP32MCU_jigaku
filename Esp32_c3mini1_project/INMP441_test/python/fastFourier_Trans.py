...
data = pd.read_csv("D:\Esp-idf\Mysource\inmp441_test\data_text\Freq_test\HeartBeat_raw/1000Hz/test4.csv", header=None)
...
# Tham số tín hiệu
fs = 1000  # Tần số lấy mẫu (Hz), cần thay đổi theo tín hiệu thực tế   　 
N = len(signal)  # Số mẫu
...
plt.subplot(2, 1, 1)
plt.plot(time, signal, linewidth=0.7, color='black')
